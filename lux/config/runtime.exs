...
if config_env() in [:dev, :test] do
  config :lux, :api_keys,
    ...
    youtube_access_token: env!("YOUTUBE_ACCESS_TOKEN", :string!, "missing youtube access token"),
    youtube_client_id: env!("YOUTUBE_CLIENT_ID", :string!, "missing youtube client id"),
    youtube_client_secret: env!("YOUTUBE_CLIENT_SECRET", :string!, "missing youtube client secret"),
